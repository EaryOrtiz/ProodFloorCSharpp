...
namespace ProdFloor.Models
{
    public interface IWiringRepository
    {
        ...
        void SaveWiringReason2(WiringReason1 wiringReason2);
        void SaveWiringReason3(WiringReason1 wiringReason3);
        void SaveWiringReason4(WiringReason1 wiringReason4);
        void SaveWiringReason5(WiringReason1 wiringReason5);
        ...
        WiringReason5 DeleteWiringReason3(int wiringReason3ID);
        WiringReason3 DeleteWiringReason4(int wiringReason4ID);
